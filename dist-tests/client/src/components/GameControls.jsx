...
export default function GameControls(_a) {
    var onNewGame = _a.onNewGame;
    var _b = useState(false), showRulesModal = _b[0], setShowRulesModal = _b[1];
    ...
    return (<>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6" data-testid="game-controls">
        ...
        <div className="space-y-3">
          <button className="w-full bg-blue-50 hover:bg-blue-100 text-blue-700 py-2 px-4 rounded-lg transition-colors flex items-center justify-center" onClick={onNewGame} data-testid="button-new-game">
            <RotateCcw className="mr-2 h-4 w-4"/>
            New Game
          </button>

          <button className="w-full bg-blue-50 hover:bg-blue-100 text-blue-700 py-2 px-4 rounded-lg transition-colors flex items-center justify-center" onClick={function () { return setLocation("/"); }} data-testid="button-return-lobby">
            <Home className="mr-2 h-4 w-4"/>
            Return to Lobby
          </button>

          <button className="w-full bg-blue-50 hover:bg-blue-100 text-blue-700 py-2 px-4 rounded-lg transition-colors flex items-center justify-center" onClick={function () { return setShowRulesModal(true); }} data-testid="button-rules">
