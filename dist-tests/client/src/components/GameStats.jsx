export default function GameStats(_a) {
    var gameState = _a.gameState, currentPlayerId = _a.currentPlayerId;
    var game = gameState.game, playerStats = gameState.playerStats;
    ...
    var currentScore = game.roomCode && currentPlayerId
        ? (currentPlayerId === game.player1Id ? game.player1Score : game.player2Score)
        : game.player1Score; // Single player fallback
    var progressPercentage = (currentScore / game.targetScore) * 100;
    return (<div className="bg-white rounded-xl shadow-sm p-6 mb-6" data-testid="game-stats">
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div className="bg-blue-600 h-2 rounded-full transition-all duration-300" style={{ width: "".concat(progressPercentage, "%") }} data-testid="progress-bar"/>
          </div>
        </div>
