...
export function setupVite(app, server) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, createViteServer, createLogger, viteLogger, viteConfig, serverOptions, vite;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, import("vite")];
                case 1:
                    _a = _b.sent(), createViteServer = _a.createServer, createLogger = _a.createLogger;
                    viteLogger = createLogger();
                    return [4 /*yield*/, import("../vite.config")];
                case 2:
                    viteConfig = (_b.sent()).default;
                    serverOptions = {
                        middlewareMode: true,
                        hmr: { server: server },
                        allowedHosts: true,
